...
\begin{itemize}
  ...
  \item 將一枚\TokenTri{Knowledge Roll}、一枚\TokenTri{Sanity Roll}、一枚\Monster{purple}（代表\Boss{Ghost}）放置在一旁備用。
  \item 若\Room{Pentagram Chamber}不在屋內，將其找擺放到地下室，並且距離你五格以上的房間。如果沒有距離五格以上的房間，則擺放在該樓層盡量越遠越好。然後洗勻排堆。
\end{itemize}

\HauntSection{對於英雄你知道}
他們正趕著在你之前召喚\Boss*{Ghost}。如果他們成功了，他們將掌控\Boss*{Ghost}並且獲得一項任務去完成。如果他們失敗，他們將改為消滅\Boss*{Ghost}。

\HauntSection{你獲勝於…}
…所有英雄皆死亡時，無論是誰先召喚出\Boss*{Ghost}。

\HauntSection{如何召喚\Boss*{Ghost}}
你與英雄們必須比賽誰先召喚\Boss*{Ghost}。你必須先執行降魂儀式以召喚\Boss*{Ghost}：
\begin{itemize}
  ...
  \item 如果你在英雄之前完成降魂儀式，你即掌控\Boss*{Ghost}（依照下一節的指示），並將\Boss*{Ghost}標記放置你所在的房間內。如果英雄們成功完成降魂儀式，他們會告知你發生了什麼事。
\end{itemize}
...
\HauntMobStatusSection{\Boss{Ghost}}
\HauntMobStatus{速度４\quad{}神志６}
\begin{itemize}
  \item 若你搶在英雄之前完成降魂儀式，或是他們先完成了降魂儀式卻在任務中失敗了，你皆會掌控\Boss*{Ghost}。若你的探險者死亡，你依然繼續掌控\Boss*{Ghost}。
  \item \Boss*{Ghost}每回合必須向一名英雄移動，並且盡可能地進行攻擊。
  \item 在\Boss*{Ghost}的第一個回合結束時起，這棟房屋開始崩塌。第一個崩塌的房間必定是\Room{Attic}，若\Room*{Attic}不存在，則選擇任何一個沒有人的樓上房間。隨後，在每個探險者的回合結束時，要求他選擇一間房間進行崩塌。
  ...
  \item 只有\Boss*{Ghost}可以通過崩塌房間。\Boss*{Ghost}亦可穿過牆壁移動，但不可穿過天花板及地板。
\end{itemize}
...
\begin{itemize}
  ...
  \item \Boss*{Ghost}以神志進行攻擊，並造成精神傷害。只有持有\Omen{Ring}、或是與\Boss*{Ghost}同處於\Room{Pentagram Chamber}內的英雄可以（且只能）使用神志攻擊\Boss*{Ghost}。
