...
\vspace*{-1em}
\begin{itemize}
  \item 當英雄變成\Monster*{Frog}時，丟下所持有的所有物品及同伴卡牌，並將其力量及知識屬性降至最低數值。\Monster*{Frog}不可攻擊、抽牌、或探索新房間。其他不是\Monster*{Frog}的探險者可如同物品般攜帶\Monster*{Frog}（\Monster*{Frog}在被攜帶時無法進行任何行動）。
