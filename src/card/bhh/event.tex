...
\begin{EventCard}{bhh}{Creepy Puppet}{陰森傀儡}
  \begin{CardStory}
    ...
    他突然拿起小小的矛向你跳去⋯
  \end{CardStory}
  你的右方的玩家代替傀儡，對你的進行力量４的攻擊。\smallbreak
...
\begin{EventCard}{bhh}{Debris}{瓦礫}
  ...
  此後每回合一次，你皆可進行力量檢定達 4+ 嘗試掙脫。其他探險者也能用此方法幫你掙脫。\smallbreak
...
\end{CardStory}
  持有\Item{Puzzle Box}的探險者，必須立即將它丟棄，提供約拿玩具玩，並抽取１張道具卡。\smallbreak
...
\begin{EventCard}{bhh}{Secret Passage}{秘密通道}
  ...
  \begin{itemize}
    ...
    \item[0-1] 任意一間地下房間中。
  \end{itemize}
  你現在就可以使用祕密通道，就算你已耗盡行動步數亦可。\smallbreak
  此後，任何探險者皆可以使用通道，並花費１點行動步數。\smallbreak
\end{EventCard}%
\linebreak[0]%
\begin{EventCard}{bhh}{Secret Stairs}{秘密階梯}
  ...
  你現在就可以使用祕密階梯，就算你已耗盡行動步數亦可。若你選擇現在使用階梯，到達新房間時，必須再抽取１張事件卡。\smallbreak
  此後，任何探險者皆可以使用通道，並花費１點行動步數。\smallbreak
\end{EventCard}%
\linebreak[0]%
...
\begin{EventCard}{bhh}{Webs}{蜘蛛網}
  ...
  此後每回合一次，你皆可進行力量檢定達 4+ 嘗試掙脫。其他探險者也能用此方法幫你掙脫。檢定失敗的探險者，回合立即結束。\smallbreak
  若檢定三次失敗，你自動掙脫並丟棄此卡，從下回合開始正常行動。\smallbreak
\end{EventCard}%
\linebreak[0]%
