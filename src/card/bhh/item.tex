...
\begin{ItemCard}{bhh}{Adrenaline Shot}{}
  \begin{CardStory}
    一管含奇怪螢光液體的針筒。
  \end{CardStory}
  每當你進行任何\Roll{Trait}前，可注入此劑，使你擲出的結果增加４點。 \smallbreak
...
\begin{ItemCard}{bhh}{Candle}{}
  ...
  若你同時持有\Item{Bell}、\Omen{Book}、\Item{Candle}時，立即獲得２級全屬性。但若你失去任何一樣，立即失去２級全屬性。\smallbreak
\end{ItemCard}%
\linebreak[0]%
...
\begin{ItemCard}{bhh}{Idol}{}
  \begin{CardStory}
    ...
    像是活體獻祭…
  \end{CardStory}
  每回合一次，當你進行任何\Roll*{Trait}、\Roll*{Combat}、或\Roll{Event}前，可摩擦\ThisName{}並犧牲１級神志，多擲２顆骰（至多８顆）。\smallbreak
\end{ItemCard}%
\linebreak[0]%
...
\begin{ItemCard}{bhh}{Pickpocket’s Glove}{}
  \begin{CardStory}
    幫助自己從未如此容易。
  \end{CardStory}
  當你與其他探險者處於同一房間時，可以使用\ThisName{}，任意搶奪該探險者所持有的其中一項物品。\smallbreak
  使用後將\ThisName{}丟棄。\smallbreak
\end{ItemCard}%
\linebreak[0]%
